...
- Live page supports config `lives` direct channel groups plus M3U/TXT live subscriptions, password-protected groups, group/channel/source switching, last channel persistence, EPG program lookup, and ArkUI `Video` playback.

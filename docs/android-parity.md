...
4. Expand live parity from the current direct M3U/TXT playback and initial EPG list to Android EPG logo/name alias mapping, password/hidden-channel prompts, live headers, time-shift, player-kernel mapping, and numeric remote switching.

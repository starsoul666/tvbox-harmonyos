...
4. Expand live parity from the current direct M3U/TXT playback and EPG time-shift flow to hidden-channel handling, live headers, and player-kernel mapping.

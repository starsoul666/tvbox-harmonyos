...
4. Expand live parity from the current direct M3U/TXT playback and initial EPG list to hidden-channel handling, live headers, time-shift, player-kernel mapping, and remote-control key capture.
